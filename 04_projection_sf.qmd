...
[CRS Explorer](https://crs-explorer.proj.org) met à disposition les références de très nombreux systèmes coordonnées (voir aussi [epsg.io](https://epsg.io/) et [epsg.org](https://epsg.org))
