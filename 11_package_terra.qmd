...
L'objectif du package `terra` [@R-terra] est de proposer des méthodes de traitement et d'analyse de données rasrer.
Ce package est très similaire au package `raster`; mais il propose plus de fonctionnalités, il est plus facile à utiliser et il est plus rapide. 
