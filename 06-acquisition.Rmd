...
- <img src="img/geom.svg" alt="Géométries" width="20"> `cshapes` : met à disposition les frontières nationales, de 1886 à aujourd'hui.   
...
- <img src="img/geom.svg" alt="Géométries" width="20"> `sen2r` : permet de télécharger et prétraiter automatiquement les données du satellite Sentinel-2.   
...
- <img src="img/geom.svg" alt="Géométries" width="20"> `COGugaison` [@COGugaison2022] et `CARTElette` : Manipulation, agrégation de données communales françaises et création de couches cartographiques à partir du code officiel géographique (COG) et des couches IGN.
...
- <img src="img/geom.svg" alt="Géométries" width="20"> `chilemapas` : donne accès aux  divisions politiques et administratives du **Chili**. 
